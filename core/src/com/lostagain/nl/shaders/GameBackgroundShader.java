 ...
 *
 */
public class GameBackgroundShader extends DefaultShader {

	final static String logstag = "ME.GameBackgroundShader";

	public static class  GameBackgroundShaderAttribute extends Attribute {
		public final static String Alias = "GameBackgroundShaderAttribute";
		 ...
		 */
		public  GameBackgroundShaderAttribute (final Texture normalMap) {
		...
		public Attribute copy () {
			return new  GameBackgroundShaderAttribute(normalMap);
		}

		@Override
		protected boolean equals (Attribute other) {
			if (
					(((GameBackgroundShaderAttribute)other).normalMap == normalMap) 
					)
	...
	public GameBackgroundShader(Renderable renderable) {
		super(renderable);	
	...
	public void init () {
		...
		String vert = Gdx.files.internal("shaders/gamebackground.vert.glsl").readString();
		String frag = Gdx.files.internal("shaders/gamebackground.frag.glsl").readString();
	...
	public void begin (Camera camera, RenderContext context) {  
		...
		program.setUniformf(LightColor, mouselight.color.r, mouselight.color.g, mouselight.color.b, mouselight.intensity*20.0f);
		...
		program.setUniformf(u_resolution, 400,400); //temp?
	...
	public void render (Renderable renderable) {  
		...
		GameBackgroundShaderAttribute normal = ((GameBackgroundShaderAttribute)renderable.material.get(GameBackgroundShaderAttribute.ID)); 
	...
	public boolean canRender (Renderable instance) {
		...
		if (instance.material.has( GameBackgroundShaderAttribute.ID)){
