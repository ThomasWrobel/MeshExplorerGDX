...
public class PrettyBackground implements Shader {
	...
	public void init () {
		...
		String vert = Gdx.files.internal("shaders/prettybackground.vertex.glsl").readString();
		String frag = Gdx.files.internal("shaders/prettybackground.fragment.glsl").readString();
