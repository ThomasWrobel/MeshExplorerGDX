...
public class DefaultStyles {
	 ...
	 * 
	 * defaults to red**/
	static public Color getColorsFromNode(SSSNode node){
		
		Color newcolor = Color.RED;
		
		Gdx.app.log(logstag, " getting nodes apperance ");
		
		HashSet<SSSNodesWithCommonProperty> populationPropertys = SSSNodesWithCommonProperty.getCommonPropertySetsContaining(node.PURI);
	...
	//normalise the string by going to lower case and replacing spaces with _
